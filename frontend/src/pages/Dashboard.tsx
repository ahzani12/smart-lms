    ...
    <div className="p-6 space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-500">Selamat datang di Sistem Digital Sekolah</p>
        </div>
        <div className="flex items-center gap-2 px-4 py-2 rounded-xl bg-indigo-50 text-indigo-600">
      ...
      <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-3">
          {[
            ...
            <div key={item.k} className={`${item.color} rounded-xl p-4 text-center`}>
              <div className="text-2xl font-bold">{stats?.attendance_today?.[item.k] ?? 0}</div>
      ...
      <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
        ...
        <div className="flex gap-4 overflow-x-auto pb-2">
          {(stats?.upcoming_events || []).map((event: any) => (
            <div key={event.id} className="flex-shrink-0 w-56 p-4 rounded-xl bg-gradient-to-br from-indigo-50 to-purple-50 border border-indigo-100">
